...
declare module 'vscode' {
	...
	export interface LanguageModelChat {
		...
		/**
		 * A well-known identifier of the vendor of the language model. An example is `acuxcode`, but
	...
	export namespace lm {
		 ...
		 * @param vendor The vendor for this provider. Must be globally unique. An example is `acuxcode` or `openai`.
		 * @param provider The provider to register
		 * @returns A disposable that unregisters the provider when disposed
		 */
