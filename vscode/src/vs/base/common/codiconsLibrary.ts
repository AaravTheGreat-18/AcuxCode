...
export const codiconsLibrary = {
	...
	// Removed copilot-warning icon - replaced with AcuxCode functionality
	python: register('python', 0xec39),
	// Removed copilot-large icon - replaced with AcuxCode functionality
	// Removed copilot-warning-large icon - replaced with AcuxCode functionality
	keyboardTab: register('keyboard-tab', 0xec3c),
	// Removed copilot-blocked icon - replaced with AcuxCode functionality
	// Removed copilot-not-connected icon - replaced with AcuxCode functionality
	...
	// Removed copilot-unavailable icon - replaced with AcuxCode functionality
	...
	// Removed copilot-in-progress icon - replaced with AcuxCode functionality
	// Removed copilot-error icon - replaced with AcuxCode functionality
	// Removed copilot-success icon - replaced with AcuxCode functionality
	...
	// Removed copilot-snooze icon - replaced with AcuxCode functionality
