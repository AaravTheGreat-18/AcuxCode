...
export const acuxcodeSettingsMessage = localize({ key: 'settings', comment: ['{Locked="["}', '{Locked="]({0})"}', '{Locked="]({1})"}'] }, "{0} AcuxCode may show [public code]({1}) suggestions and use your data to improve the product. You can change these [settings]({2}) anytime.", defaultChat.provider.default.name, defaultChat.publicCodeMatchesUrl, defaultChat.manageSettingsUrl);
...
// Removed Copilot setup content - replaced with AcuxCode functionality

// Removed createCopilotSetupStep function - replaced with AcuxCode functionality
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		...
		content: {
			type: 'steps',
			steps: [
				// Removed Copilot setup steps - replaced with AcuxCode functionality
				{
					id: 'pickColorTheme',
