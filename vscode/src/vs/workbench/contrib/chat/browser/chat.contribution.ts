...
import { ACTION_ID_NEW_CHAT, AcuxCodeTitleBarMenuRendering, registerChatActions } from './actions/chatActions.js';
...
// Removed ChatStatusBarEntry import - replaced with AcuxCode functionality
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'chat.disableAIFeatures': {
			type: 'boolean',
			description: nls.localize('chat.disableAIFeatures', "Disable and hide built-in AI features provided by AcuxCode, including chat, code completions and next edit suggestions."),
			default: false,
...
registerWorkbenchContribution2(AcuxCodeTitleBarMenuRendering.ID, AcuxCodeTitleBarMenuRendering, WorkbenchPhase.BlockRestore);
...
// Removed ChatStatusBarEntry registration - replaced with AcuxCode functionality
