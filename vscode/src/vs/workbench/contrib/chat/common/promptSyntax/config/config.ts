...
export namespace PromptsConfig {
	...
	/**
	 * Configuration key for use of the acuxcode instructions file.
	 */
	export const USE_ACUXCODE_INSTRUCTION_FILES = 'acuxcode.chat.codeGeneration.useInstructionFiles';
